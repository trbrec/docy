...
check("monitor giornaliero mantiene hosting e credito senza quota pCloud", "temp_min_free_bytes" in RESOURCE and "'acr-connection'" in RESOURCE and "lettura dello spazio da collegare" not in RESOURCE)
...
check("quota pCloud disattivata, protezione trasferimenti mantenuta", "function trb_resource_pcloud_userinfo()" not in RESOURCE and "function trb_resource_pcloud_guard( $incoming_bytes )" in RESOURCE and "webdav-transfer-guard" in RESOURCE and "pcloud_space_monitor_removed" in RESOURCE)
