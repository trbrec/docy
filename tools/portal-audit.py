...
check("email artista solo per incidente confermato", "trb_resource_notify_artist_pipeline_recovery" in RESOURCE and "confirmed-incident-" in RESOURCE and "if ( ! $confirmed_incident" in RESOURCE and "La problematica dipendeva dal portale" in RESOURCE)
