...
check("coda email conserva CC e Reply-To validati", "headers longtext NULL" in RESOURCE and "Cc|Reply-To" in RESOURCE and "TRB_RESOURCE_MONITOR_VERSION', '1.1.0" in RESOURCE)
