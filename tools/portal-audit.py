...
check("genere demo orienta OpenAI senza imporre stereotipi", "Genere musicale dichiarato dall'artista" in DEMO and "Non forzare il materiale dentro uno stereotipo di genere" in DEMO)
