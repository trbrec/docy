...
try{
    foreach([44100,48000,96000] as $rate){
        ...
        tp_assert(trb_true_peak_findings($result)['errors']===['TRUE_PEAK_ABOVE_ZERO'],'Above-zero true peak must fail');
    ...
    tp_assert(trb_true_peak_findings(['verified'=>true,'complete_file'=>true,'maximum_dbtp'=>0])['warnings']===['TRUE_PEAK_ZERO_REVIEW'],'Rounded zero falsely certified');
