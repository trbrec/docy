...
check($mail!==null&&str_contains($mail['body'],'Il nostro consiglio professionale')&&!str_contains($mail['body'],'50%'),'project service remains visible independently of Store activation');
