...
const context={module:{exports:{}},FormData,XMLHttpRequest:XHR,console};
...
const form={dataset:{},action:'/upload',querySelectorAll(){return [{name:'trb_track_audio[0]',files:[file]}];},querySelector(s){if(s.includes('submission_token'))return {value:'session'};if(s.includes('stage_nonce'))return {value:'nonce'};if(s.endsWith(':checked'))return {value:selected};if(s.includes('type="hidden"'))return null;return {value:'mastered'};}};
(async()=>{
