...
<div class="woocommerce-billing-fields">
	...
	<?php if ( wc_ship_to_billing_address_only() && WC()->cart->needs_shipping() ) : ?>
        <h3 class="checkout_title f_p f_600 f_size_20 mb_40">
			<?php esc_html_e( 'Billing &amp; Shipping', 'docy' ); ?>
        </h3>
	<?php else : ?>
        <h2 class="checkout_title f_p f_600 f_size_20 mb_40">
			<?php esc_html_e( 'Billing details', 'docy' ); ?>
        </h2>
	<?php endif; ?>

	<?php do_action( 'woocommerce_before_checkout_billing_form', $checkout ); ?>

    <div class="woocommerce-billing-fields__field-wrapper row p-2">
		<?php
		...
		<?php if ( ! $checkout->is_registration_required() ) : ?>
            ...
            <p class="form-row form-row-wide create-account">
                <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                    ...
                    <span> <?php esc_html_e( 'Create an account?', 'docy' ); ?> </span>
                </label>
            </p>
