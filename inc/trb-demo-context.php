...
- Per citare versi originali usa esclusivamente «caporali», copiando un frammento contiguo dal testo nuovo o precedente senza cambiare parole o tempi verbali. Indica sempre quale versione citi. Non usare caporali per titolo, parafrasi, commenti o alternative: scrivi le proposte in corsivo e introducile con una formula italiana naturale, per esempio "Una possibile alternativa è". Usa "alternativa" al singolare per una sola proposta e "alternative" al plurale per più proposte; non usare etichette con iniziali maiuscole dentro la frase. Le citazioni saranno confrontate automaticamente con i testi sorgente.
...
- Lingua: verifica accordi, articoli e singolare/plurale in tutta la prosa. Preferisci parole comuni quando sono altrettanto precise; spiega i termini tecnici necessari nel contesto. Non ripetere il titolo del brano nel commento consulenziale: usa "il brano" o "il testo".
