...
function trb_portal_dashboard_shortcode() {
	...
	<div class="trb-portal" data-profile="<?php echo esc_attr( $profile ); ?>">
		...
		<?php else : ?>
			<?php trb_portal_render_resource_section( 'risposte', 'Risposte rapide', 'Le guide aggiornate per fare subito il passo corretto.', $resources['trb_guide'] ); ?>
