	...
	<template id="trb-portal-track-template">
		<article class="trb-portal__track" data-track>
			...
			<div class="trb-track-block"><h4>Informazioni del brano</h4><div class="trb-portal__field-grid">
				...
				<label class="trb-track-existing-isrc" data-existing-isrc hidden>ISRC del brano già pubblicato <span aria-hidden="true">*</span><input type="text" name="trb_existing_isrc[__INDEX__]" minlength="12" maxlength="12" pattern="[A-Z]{2}[A-Z0-9]{3}[0-9]{7}" inputmode="latin" autocomplete="off" autocapitalize="characters" spellcheck="false" placeholder="Es. ITV242600005" disabled /><small>Inserisci le 12 cifre e lettere dell’ISRC, senza spazi o trattini.</small></label>
