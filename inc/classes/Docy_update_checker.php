...
if ( !class_exists('ThemeUpdateChecker') ):
    ...
    class ThemeUpdateChecker {
        ...
        public function injectUpdate($updates){
            ...
            // Ensure $updates is an object before modifying it
...
if ( !class_exists('ThemeUpdate') ):
    ...
    class ThemeUpdate {
        ...
        public function toWpFormat(){
            ...
            if ( !empty($this->du) ){
                $update['package'] = docy_decode_du($this->du);
            }
...
if ( $purchase_code_status == 'valid' ) {
    $update_checker = new ThemeUpdateChecker(
        'docy',
        'https://wordpress-theme.spider-themes.net/resources/docy/theme-info.json'
    );
}