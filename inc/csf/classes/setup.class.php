  ...
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      wp_localize_script( 'csf', 'csf_vars', array(
        ...
        'i18n'              => array(
          'confirm'         => esc_html__( 'Are you sure?', 'docy' ),
          'typing_text'     => esc_html__( 'Please enter %s or more characters', 'docy' ),
          'searching_text'  => esc_html__( 'Searching...', 'docy' ),
          'no_results_text' => esc_html__( 'No results found.', 'docy' ),
        ),
      ) );
    ...
    public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
      ...
      if ( ! empty( $field['_notice'] ) ) {
        ...
        $field            = array();
        $field['content'] = esc_html__( 'Oops! Not allowed.', 'docy' ) .' <strong>('. $field_type .')</strong>';
        $field['type']    = 'notice';
        $field['style']   = 'danger';
      ...
      if ( ! empty( $field_type ) ) {
        ...
        if ( class_exists( $classname ) ) {
          ...
          echo '<p>'. esc_html__( 'Field not found!', 'docy' ) .'</p>';
        }
