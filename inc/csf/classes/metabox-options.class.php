        ...
        echo '<div class="csf-wrapper'. esc_attr( $show_all ) .'">';
          ...
          echo '<div class="csf-content">';
            ...
            if ( ! empty( $this->args['show_restore'] ) || ! empty( $this->args['show_reset'] ) ) {
              ...
              echo '<span class="button csf-button-reset">'. esc_html__( 'Reset', 'docy' ) .'</span>';
              echo '<span class="button csf-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'docy' ), esc_html__( 'Cancel', 'docy' ) ) .'</span>';
              echo '</label>';
              echo '</div>';
