  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'docy' ),
        'right_placeholder'  => esc_html__( 'right', 'docy' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'docy' ),
        'left_placeholder'   => esc_html__( 'left', 'docy' ),
        'all_placeholder'    => esc_html__( 'all', 'docy' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'docy' ),
        'dashed'    => esc_html__( 'Dashed', 'docy' ),
        'dotted'    => esc_html__( 'Dotted', 'docy' ),
        'double'    => esc_html__( 'Double', 'docy' ),
        'inset'     => esc_html__( 'Inset', 'docy' ),
        'outset'    => esc_html__( 'Outset', 'docy' ),
        'groove'    => esc_html__( 'Groove', 'docy' ),
        'ridge'     => esc_html__( 'ridge', 'docy' ),
